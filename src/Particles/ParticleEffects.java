...
public enum ParticleEffects {
	...
	static {
		...
		try {
			packetPlayOutWorldParticles = ReflectionUtilities.getConstructor(
					PacketType.PLAY_OUT_WORLD_PARTICLES.getPacket(),
					String.class, float.class, float.class, float.class,
					float.class, float.class, float.class, float.class,
					int.class);
			getHandle = ReflectionUtilities.getMethod("CraftPlayer",
					SubPackageType.ENTITY, "getHandle");
			playerConnection = ReflectionUtilities.getField("EntityPlayer",
					PackageType.MINECRAFT_SERVER, "playerConnection");
			sendPacket = ReflectionUtilities.getMethod(playerConnection
					.getType(), "sendPacket", ReflectionUtilities.getClass(
